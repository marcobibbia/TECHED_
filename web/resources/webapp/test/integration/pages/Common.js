sap.ui.define([
		...
		function getFrameUrl (sHash, sUrlParameters) {
			var sUrl = jQuery.sap.getResourcePath("dummz/app", ".html");
			sHash = sHash || "";
		...
		return Opa5.extend("dummz.test.integration.pages.Common", {
			...
			getMockServer : function () {
				return new Promise(function (success) {
					Opa5.getWindow().sap.ui.require(["dummz/localService/mockserver"], function (mockserver) {
